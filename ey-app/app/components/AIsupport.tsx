...
export default function AISupport() {
  ...
  return (
    ...
    shadow-[0_0_0_1px_rgba(59,130,246,0.2),0_8px_30px_rgba(0,0,0,0.8)]
  ...
  "
        >
          AI Assistant Online
          <div className="absolute -bottom-1 right-5 w-2 h-2 bg-black rotate-45 border-r border-b border-blue-500/20" />
        </div>
      </motion.button>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="p-5 bg-linear-to-br from-neutral-800 to-neutral-900 border-b border-yellow-300/20 flex justify-between items-center">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() => {
                                ProductRanker.trackPopularity(
                                  selectedProduct.id,
                                  "click"
                                );
                                handleProductAction(selectedProduct, "like");
                              }}
                              className="px-4 py-2 border border-blue-500 text-blue-400 hover:bg-blue-500/10 rounded-lg flex items-center gap-2"
                            >
                            ...
                            <button
                              onClick={() => {
                                ...
                                handleProductAction(selectedProduct, "save");
                              }}
                              className="px-4 py-2 bg-linear-to-br from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black font-medium rounded-lg flex items-center gap-2"
                            >
            ...
            <div className="p-4 border-t border-neutral-800 bg-neutral-900 space-y-3">
              ...
              <div className="flex gap-2">
                <div className="flex-1 relative">
                  <input
                    ...
                    placeholder="Ask me anything about fashion, products, or style..."
                ...
                <motion.button
                  ...
                  className="px-5 bg-linear-to-br from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 disabled:from-neutral-700 disabled:to-neutral-800 disabled:cursor-not-allowed rounded-xl flex items-center justify-center transition-all"
                >
              ...
              <div className="flex justify-between text-xs text-gray-500">
                <div className="flex items-center gap-4">
                  ...
                  {userProfile.savedProducts.length > 0 && (
                    <button
                      onClick={() => setInput("Show my saved items")}
